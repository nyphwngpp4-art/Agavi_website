...
export default function BottomNav({ activeTab, onTabChange }) {
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-40 backdrop-blur-xl border-t border-line pb-safe" style={{ background: 'rgba(2,9,19,.9)' }}>
        ...
        {tabs.map((tab, i) => (
          <button
            ...
            className={`flex flex-col items-center justify-center w-full h-full transition-colors duration-150 ${
              activeTab === i ? 'text-accent' : 'text-gray-500'
            }`}
          >
